...
//    }
    ...
    @GetMapping({"/getProductDetails/{isSingleCheckout}/{productId}"})
    public List<Product> getProductDetails(@PathVariable(name = "isSingleCheckout") boolean isSingleCheckout,
